      ...
      {({ selectedNetwork }) => {
        ...
        return (
          <>
            ...
            <main className="flex-grow container px-4 mx-auto max-w-7xl py-16 text-gray-900 dark:text-white">
              <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                <h1 className="text-4xl font-bold mb-8 md:mb-0 text-gray-900 dark:text-white text-center">Community tokens on {selectedNetwork.name}</h1>
